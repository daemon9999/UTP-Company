    ...
    <section id="pipeline-map" className="bg-primary">
      <div className="container mx-auto w-5/6 flex flex-col items-center gap-y-5 pt-14">
        ...
        <div className="w-auto h-[200px] sm:h-[300px] relative md:h-[500px] mx-auto ">
            <a href="https://sjskjsjaqeuexbandiqoxd.on.drv.tw/map.html" target="_blank" className="absolute top-4 right-4 sm:top-7 sm:right-7 md:top-10 md:right-10 bg-blue-400 inline-flex items-center justify-center text-white  font-semibold text-sm sm:text-base md:text-lg px-2 py-1 rounded-full hover:bg-blue-300 transition-all ">
                Map View
            </a>
          <img
